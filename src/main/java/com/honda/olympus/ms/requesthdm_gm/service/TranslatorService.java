...
public class TranslatorService {
    ...
    public MtocTranslatorResponse sendRequest(MTOCTranslator mtocTranslator) {
        try {
            MtocTranslatorResponse response = translatorClient.sendRequest(mtocTranslator).getBody();
